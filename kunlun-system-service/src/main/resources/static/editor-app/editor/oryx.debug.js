...
//		}
	...
	/**
	 * @return {Array} An array of all basedata morph stencils
	 */
	baseMorphs: function() {
		var _baseMorphs = [];
	...
	connectMorph: function(args) {	
		...
		if(baseEdgeStencils.size()>0)
			return baseEdgeStencils[0]; // return any of the possible basedata morphs
...
/**
 * @classDescription Abstract basedata class for all objects that have a graphical representation
 * within the editor.
 * @extends Clazz
 */
ORYX.Core.UIObject = {
...
ORYX.Core.Canvas = ORYX.Core.AbstractShape.extend({
	...
	/**
	 * buggy crap! use basedata class impl instead!
	 * @param {Object} iterator
	 */
...
ORYX.Core.Shape = {
	 ...
	 */
	construct: function(options, stencil, facade) {
		// call basedata class constructor
		arguments.callee.$.construct.apply(this, arguments);
	 ...
	 */
	refresh: function() {
		//call basedata class refresh method
...
/**
 * @classDescription Abstract basedata class for all Controls.
 */
...
/**
 * @classDescription Abstract basedata class for all Nodes.
...
/**
 * @classDescription Abstract basedata class for all connections.
 * @extends {ORYX.Core.Shape}
 * @param options {Object}
 *
